...
const features = [{
  ...
  flow_steps:[{order:0,symbol_id:'checkout',symbol_name:'checkout',relation:'entry',unresolved_calls:[
...
describe('RepositoryMap',()=>{
  it('renders unresolved dispatch evidence on the actual map presentation',()=>{
